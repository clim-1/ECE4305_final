...
void AdsrCore::init() {
   ...
   // set note C
   _ddfs->set_carrier_freq(0,0);
   _ddfs->set_carrier_freq(0,1);
   _ddfs->set_carrier_freq(0,2);
   _ddfs->set_carrier_freq(0,3);
   _ddfs->set_carrier_freq(0,4);
   _ddfs->set_carrier_freq(0,5);
   _ddfs->set_carrier_freq(0,6);
   _ddfs->set_carrier_freq(0,7);
...
void AdsrCore::play_note(int note, int oct, int dur, int track) {
   int sus_tmp;
   int freq;

   freq = calc_note_freq(oct, note);
   _ddfs->set_carrier_freq(freq, track);
